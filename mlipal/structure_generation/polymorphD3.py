...
if __name__ == "__main__":
    ...
    structure_dir = '210224_distorted'
    ...
    xtl = build.bulk('Si', 'diamond', a=5.43)

    for i in range(1000):
        Poly = PolymorphD3(xtl, rcut = 3, flip_chance=0, swap_chance=0)
                #random_seed=0)
        atoms = Poly.atoms_out
        
        #name_out = name.replace('.cif', '.poscar' )
        io.write('{}/{:03d}.vasp'.format(structure_dir, i), atoms)
